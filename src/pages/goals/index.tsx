...
type ColumnType = ColumnDef<GoalInterface, unknown>;
...
export function GoalListPage(props: GoalListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<GoalInterface>>(
    () => `/goals?params=${JSON.stringify(params)}`,
    fetcher,
  );
